...
<html>
  <head>
	<title>Tutorials Training | Under Maintenance</title>
...
<script src="https://cdn.rawgit.com/google/code-prettify/master/loader/run_prettify.js?lang=nodeJS&amp;skin=sunburst"></script>
  ...
  <br />
		...
		<h3><code>var mode = require('standby');</code></h3>
...
e-Mail: support[at]tutorials[dot]training
accessed IP: <? echo $_SERVER['REMOTE_ADDR']; ?>
		...
		<a class="btn btn-border btn-success btn-circled" href="#"> <i class="fa fa-rss fa-lg text-success" aria-hidden="true"></i>  Meanwhile connect with us on Social Media</a>
		<br/><br />
		
		<a class="btn btn-border btn-success btn-circled" href="https://twitter.com/TutorialsTr" target="_blank"><i class="fa fa-twitter text-info" aria-hidden="true"></i> Follow us on Twitter</a>
		
		<a class="btn btn-border btn-success btn-circled" href="https://www.facebook.com/TutorialsTraining.x" target="_blank"><i class="fa fa-facebook text-primary"></i> Like us on Facebook</a>
