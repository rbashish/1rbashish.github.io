...
<html>
  <head>
	<title>rbashish | Tech Enthusiastic (RB ASHISH)</title>
	<link rel="icon" type="image/png" href="/web.png" sizes="16x16">
	<link rel="icon" type="image/png" href="/web.png" sizes="32x32">
...
<script src="https://cdn.rawgit.com/google/code-prettify/master/loader/run_prettify.js?lang=nodeJS&amp;skin=sunburst"></script>
    ...
    <link href="https://tutorials.training/css/style-main.css" media="screen" rel="stylesheet" />
  ...
  <body class="background error-page-wrapper background-color background-image">
	...
	<div class="content-container shadow">
		...
		<p><strong>This website is undergoing a bit of
			update maintenance. Please Stand by!</strong> <br />
  Thanks for your patience!</p>
  <br />
  </div>
		<div class="subheader primary-text-color">
		<h3><code>var mode = require('patience');</code></h3>
...
e-Mail: contact[at]aashish[dot]co[dot]in
accessed IP: <? echo $_SERVER['REMOTE_ADDR']; ?>
		...
		<a class="btn btn-border btn-success btn-circled" href="https://aashish.co.in"> <i class="fa fa-rss fa-lg text-success" aria-hidden="true"></i>  Meanwhile visit my blog</a>
		<br/><br />
		
		<a class="btn btn-border btn-success btn-circled" href="https://www.amazon.in/rbashish-Artificial-Intelligence-AI-Facts/dp/B0792FYDD1" target="_blank"><i class="fa fa-amazon text-warning" aria-hidden="true"></i> Alexa app</a>
		
		<a class="btn btn-border btn-success btn-circled" href="https://assistant.google.com/services/a/uid/0000009151e0d5c2" target="_blank"><i class="fa fa-google text-primary"></i> Assistant app</a>
