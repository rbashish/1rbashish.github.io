  ...
  <body class="background error-page-wrapper background-color background-image">
	...
	<div class="content-container shadow">
		<div class="head-line secondary-text-color">
		 ...
		 <p><strong>This blog is undergoing a bit of
			update maintenance. <br /> Please check back later!</strong> <br /></p>
...
accessed IP: <? echo $_SERVER['REMOTE_ADDR']; ?>
		...
		<a class="btn btn-border btn-success btn-circled" href="https://rbashish.tech"> <i class="fa fa-rss fa-lg text-success" aria-hidden="true"></i>  Meanwhile visit my website</a>
		<br/><br />
